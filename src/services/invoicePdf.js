 ...
 * Rs 173000.00
 *
 * No commas and exactly two decimal places.
 */
...
export async function generateInvoicePDF(invoice, download = true) {
  ...
  const tableMargin =
    margin + tableSideMargin;

  const tableWidth =
    pageWidth - (tableMargin * 2);

  const tableTop =
    billToY + billToHeight + 2;
